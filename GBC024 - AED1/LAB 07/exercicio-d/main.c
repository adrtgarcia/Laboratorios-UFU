...
int main ( )
{
    ...
    aluno a;
    int opcao, op_lista, retorno, posicao, chave, nos;
    ...
    while (1)
    {
        ...
        printf ("\n 8 - remover n primeiras posicoes da lista");
        printf ("\n 9 - buscar aluno chave na lista");
        printf ("\n10 - buscar posicao na lista");
        printf ("\n11 - buscar item na lista");
        printf ("\n12 - concatenar listas");
        printf ("\n13 - procurar aluno com maior nota");
        printf ("\n14 - limpar a lista");
        printf ("\n15 - mostrar a lista");
        ...
        switch (opcao)
        {
            ...
            case 8:
                do
                {
                    printf ("\ndigite quantas posicoes deseja remover: ");
                    scanf ("%d", &nos);
                ...
                do
                {
                    printf ("\nde qual lista deseja remover as posicoes?");
                    printf ("\n1 - lista A, 2 - lista B\n");
                    scanf ("%d", &op_lista);
